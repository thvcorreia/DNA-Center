...
msiexec /package \\192.168.0.220\Publico\TI\00-Programas-Instalacao-Padrao\Programas\LibreOffice\LibreOffice_7.0.4_Win_x64.msi /qb
...
start /w \\192.168.0.220\Publico\TI\00-Programas-Instalacao-Padrao\Programas\vlc-3.0.12-win64.exe /L=pt_BR /S
...
start /w \\192.168.0.220\Publico\TI\00-Programas-Instalacao-Padrao\Programas\jre-8u281-windows-x64.exe /s
