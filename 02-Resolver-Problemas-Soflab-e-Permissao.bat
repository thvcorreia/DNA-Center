...
copy "\\xxxxxxx\Publico\TI\00-Programas-Instalacao-Padrao\Configuracoes\SOFTLAB.INI" C:\Users\Public\Desktop\
...
copy "\\xxxxxxx\Publico\TI\00-Programas-Instalacao-Padrao\Configuracoes\s3config.bin" "C:\ProgramData\ND Engenharia e Software\S3\SOROTECA" 
